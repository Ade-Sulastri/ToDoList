...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (userChart != null && typeof chartData !== "undefined") {
        var options = {
            chart: {
                type: "bar",
                height: 350,
            ...
            title: {
              text: 'Jumlah Pengguna Terdaftar per Bulan'
          },
          colors: ['#4fd1c5']
        };
...
// Chart task
document.addEventListener("DOMContentLoaded", function () {
    var taskChart = document.getElementById("taskChart");

    if (taskChart != null && typeof chartDataTask !== "undefined") {
        var options = {
            chart: {
                type: "bar",
                height: 350,
            ...
            series: [
                {
                    name: "Jumlah Pengguna",
                    data: chartDataTask.data,
                },
            ],
            xaxis: {
                categories: chartDataTask.labels,
            },
            title: {
              text: 'Jumlah Tugas per Bulan'
          },
          colors: ['#4fd1c5']
        };

        var chart = new ApexCharts(taskChart, options);
        chart.render();
    }
});

// var SummaryChart = document.getElementById("userChart");
